          ...
          <div className='bg-white p-6 space-y-3 rounded-2xl '>
            <div className='flex gap-2 justify-between '>
              ...
              onChange={(e) => {
               ...
               required placeholder='Add new template' className='border font-poppins rounded-full w-5/6  sm:w-11/12 lg:w-60 xl:w-80 px-2' />
            ...
            <div className='flex gap-2 justify-between '>
              <input type="text"
               ...
               required placeholder='Add Macro' className='border rounded-full font-poppins w-5/6 sm:w-11/12 lg:w-60 xl:w-80  px-2' />
              <span className='bg-[#516EFF] w-12 h-12 place-content-center  justify-items-center rounded-full'>
                <img src={plus} alt="" className='w-3 h-3 ' />
              </span>
            </div>
